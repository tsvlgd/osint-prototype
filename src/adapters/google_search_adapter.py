...
class GoogleSearchAdapter(BaseAdapter):
    """Adapter for Google search via Serper API."""
    ...
    async def fetch(self, query: str) -> List[Dict[str, Any]]:
        """Fetch social media footprints using Google dorking."""
        results = []
        if not self.api_key:
        ...
        dork_query = (
            f'"{query}" (website OR homepage OR "contact us" OR "about")'
        )
